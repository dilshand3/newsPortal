...
const EmailVerification = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.heading} onPress={() => navigation.navigate("Login")}>Email Verification</Text>
            <Text style={styles.subHeading}>We've sent an verification to <Text style={styles.email}>arun14@gmail.com</Text> to verify your email address and activate your account.</Text>
